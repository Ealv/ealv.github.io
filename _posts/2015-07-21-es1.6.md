...
* appel de fonction myFunc() (no context use global context )
* appel de method (toto.myFunc()) (implict context)
* call apply myFunc.apply(truc) .... (bounded)
* bind myFunc.bind(truc) (hard bounded)
* new call (new is the stronger)
